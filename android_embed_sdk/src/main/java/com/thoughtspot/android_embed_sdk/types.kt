...
//    data class LongValue(val value: Long) : Long__value()
    companion object {
         ...
         */
        fun fromValue(value: String): AuthType? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): AuthType =
            fromValue(value) ?: throw IllegalArgumentException("No AuthType found with value: $value")
    }
}
/**
 *
...
enum class HomeLeftNavItem(val value: String) {
    /**
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): HomeLeftNavItem? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): HomeLeftNavItem =
            fromValue(value) ?: throw IllegalArgumentException("No HomeLeftNavItem found with value: $value")
    }
}
/**
...
enum class RuntimeFilterOp(val value: String) {
    /**
     * Equals
     */
    EQ("EQ"),
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): RuntimeFilterOp? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): RuntimeFilterOp =
            fromValue(value) ?: throw IllegalArgumentException("No RuntimeFilterOp found with value: $value")
    }
}
/**
...
enum class HomepageModule(val value: String) {
    /**
     * Search bar
     */
    Search("SEARCH"),
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): HomepageModule? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): HomepageModule =
            fromValue(value) ?: throw IllegalArgumentException("No HomepageModule found with value: $value")
    }
}
/**
...
enum class ListPageColumns(val value: String) {
    /**
     * Favourite
     */
    Favourite("FAVOURITE"),
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): ListPageColumns? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): ListPageColumns =
            fromValue(value) ?: throw IllegalArgumentException("No ListPageColumns found with value: $value")
    }
}
/**
...
enum class EmbedEvent(val value: String) {
    /**
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): EmbedEvent? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): EmbedEvent =
            fromValue(value) ?: throw IllegalArgumentException("No EmbedEvent found with value: $value")
    }
}
/**
...
enum class HostEvent(val value: String) {
    /**
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): HostEvent? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): HostEvent =
            fromValue(value) ?: throw IllegalArgumentException("No HostEvent found with value: $value")
    }
}
/**
...
enum class DataSourceVisualMode(val value: String) {
    /**
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): DataSourceVisualMode? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): DataSourceVisualMode =
            fromValue(value) ?: throw IllegalArgumentException("No DataSourceVisualMode found with value: $value")
    }
}
/**
...
enum class Param(val value: String) {
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): Param? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): Param =
            fromValue(value) ?: throw IllegalArgumentException("No Param found with value: $value")
    }
}
/**
...
enum class Action(val value: String) {
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): Action? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): Action =
...
enum class PrefetchFeatures(val value: String) {
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): PrefetchFeatures? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): PrefetchFeatures =
            fromValue(value) ?: throw IllegalArgumentException("No PrefetchFeatures found with value: $value")
    }
}
/**
...
enum class ContextMenuTriggerOptions(val value: String) {
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): ContextMenuTriggerOptions? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): ContextMenuTriggerOptions =
            fromValue(value) ?: throw IllegalArgumentException("No ContextMenuTriggerOptions found with value: $value")
    }
}
/**
...
enum class LogLevel(val value: String) {
    ...
    companion object {
         ...
         * Convert a string value back to the enum constant
         */
        fun fromValue(value: String): LogLevel? = values().find { it.value == value }

        /**
         * Convert a string value to the enum constant or throw an exception if not found
         */
        fun fromValueOrThrow(value: String): LogLevel =
...
data class LiveboardViewConfig(
    val fullHeight: Boolean? = null,
    val defaultHeight: Double? = null,
    val enableVizTransformations: Boolean? = null,
    val liveboardId: String? = null,
    val pinboardId: String? = null,
    val vizId: String? = null,
    val preventLiveboardFilterRemoval: Boolean? = null,
    val visibleVizs: List<String>? = null,
    val preventPinboardFilterRemoval: Boolean? = null,
    val liveboardV2: Boolean? = null,
    val activeTabId: String? = null,
    val hideTabPanel: Boolean? = null,
    val hideLiveboardHeader: Boolean? = null,
    val showLiveboardTitle: Boolean? = null,
    val showLiveboardDescription: Boolean? = null,
    val isLiveboardHeaderSticky: Boolean? = null,
    val enableAskSage: Boolean? = null,
    val enable2ColumnLayout: Boolean? = null,
    val showPreviewLoader: Boolean? = null,
    val isLiveboardCompactHeaderEnabled: Boolean? = null,
    val showLiveboardVerifiedBadge: Boolean? = null,
    val showLiveboardReverifyBanner: Boolean? = null,
    val hideIrrelevantChipsInLiveboardTabs: Boolean? = null,
    val oAuthPollingInterval: Double? = null,
    val isForceRedirect: Boolean? = null,
    val dataSourceId: String? = null,
    val coverAndFilterOptionInPDF: Boolean? = null,
    val layoutConfig: LayoutConfig? = null,
    val frameParams: FrameParams? = null,
    val theme: String? = null,
    val styleSheet__unstable: String? = null,
    val disabledActions: List<Action>? = null,
    val disabledActionReason: String? = null,
    val hiddenActions: List<Action>? = null,
    val visibleActions: List<Action>? = null,
    val showAlerts: Boolean? = null,
    val runtimeFilters: List<RuntimeFilter>? = null,
    val runtimeParameters: List<RuntimeParameter>? = null,
    val locale: String? = null,
    val additionalFlags: LiveboardViewConfig__additionalFlags? = null,
    val customizations: CustomisationsInterface? = null,
    val insertAsSibling: Boolean? = null,
    val contextMenuTrigger: ContextMenuTriggerOptions? = null,
    val linkOverride: Boolean? = null,
    val insertInToSlide: Boolean? = null,
    val usePrerenderedIfAvailable: Boolean? = null,
    val excludeRuntimeFiltersfromURL: Boolean? = null,
    val hiddenTabs: List<String>? = null,
    val visibleTabs: List<String>? = null,
    val preRenderId: String? = null,
    val doNotTrackPreRenderSize: Boolean? = null,
    val embedComponentType: String? = null,
    val excludeRuntimeParametersfromURL: Boolean? = null,
    val enableV2Shell_experimental: Boolean? = null,
    val collapseSearchBar: Boolean? = null,
    val exposeTranslationIDs: Boolean? = null,
    val disableRedirectionLinksInNewTab: Boolean? = null,
    val dataPanelV2: Boolean? = null,
    val enableCustomColumnGroups: Boolean? = null,
...
data class CustomisationsInterface(
    val style: CustomStyles? = null,
...
data class EmbedConfig(
    ...
    val thoughtSpotHost: String,
    val authEndpoint: String? = null,
    val username: String? = null,
    val password: String? = null,
    val noRedirect: Boolean? = null,
    val inPopup: Boolean? = null,
    val redirectPath: String? = null,
    val basepath: String? = null,
    val shouldEncodeUrlQueryParams: Boolean? = null,
    val suppressNoCookieAccessAlert: Boolean? = null,
    val ignoreNoCookieAccess: Boolean? = null,
    val autoLogin: Boolean? = null,
    val disableLoginRedirect: Boolean? = null,
    val loginFailedMessage: String? = null,
    val callPrefetch: Boolean? = null,
    val queueMultiRenders: Boolean? = null,
    val detectCookieAccessSlow: Boolean? = null,
    val suppressSearchEmbedBetaWarning: Boolean? = null,
    val suppressSageEmbedBetaWarning: Boolean? = null,
    val customizations: CustomisationsInterface? = null,
    val authTriggerContainer: EmbedConfig__authTriggerContainer? = null,
    val useEventForSAMLPopup: Boolean? = null,
    val authTriggerText: String? = null,
    val blockNonEmbedFullAppAccess: Boolean? = null,
    val hostConfig: EmbedConfig__hostConfig? = null,
    val pendoTrackingKey: String? = null,
    val suppressErrorAlerts: Boolean? = null,
    val logLevel: LogLevel? = null,
    val disableSDKTracking: Boolean? = null,
    val dateFormatLocale: String? = null,
    val numberFormatLocale: String? = null,
...
data class FrameParams(
    val width: FrameParams__width? = null,
...
data class ViewConfig(
    ...
    val runtimeParameters: List<RuntimeParameter>? = null,
    val locale: String? = null,
    val additionalFlags: ViewConfig__additionalFlags? = null,
    val customizations: CustomisationsInterface? = null,
    val insertAsSibling: Boolean? = null,
    val contextMenuTrigger: ContextMenuTriggerOptions? = null,
    val linkOverride: Boolean? = null,
    ...
    val excludeRuntimeFiltersfromURL: Boolean? = null,
    val hiddenTabs: List<String>? = null,
    val hiddenHomepageModules: List<HomepageModule>? = null,
    val reorderedHomepageModules: List<HomepageModule>? = null,
    val visibleTabs: List<String>? = null,
    val hiddenHomeLeftNavItems: List<HomeLeftNavItem>? = null,
    val preRenderId: String? = null,
    val doNotTrackPreRenderSize: Boolean? = null,
    val embedComponentType: String? = null,
    val excludeRuntimeParametersfromURL: Boolean? = null,
...
data class RuntimeFilter(
    val values: List<RuntimeFilter__values>,
...
data class CustomActionPayload(
    val session: SessionInterface,
    val embedAnswerData: CustomActionPayload__embedAnswerData,
...
data class DefaultAppInitData(
    ...
    val runtimeFilterParams: String,
...
data class CustomActionPayload__embedAnswerData(
    ...
    val sources: CustomActionPayload__embedAnswerData__sources,
    val id: String,
    val name: String
)
...
/**
 * Union type for EmbedConfig__authTriggerContainer
 */
sealed class EmbedConfig__authTriggerContainer {
    /**
 ...
 */
sealed class FrameParams__width {
    /**
     * String value wrapper
     */
    ...
    companion object {
         ...
         * Convert a value to the appropriate union type
         */
        fun fromValue(value: Any): FrameParams__width {
            return when(value) {
                is String -> StringValue(value)
                is Double -> NumberValue(value)
                is Int -> NumberValue(value.toDouble())
 ...
 */
sealed class FrameParams__height {
    /**
     * String value wrapper
     */
    ...
    companion object {
         ...
         * Convert a value to the appropriate union type
         */
        fun fromValue(value: Any): FrameParams__height {
            return when(value) {
                is String -> StringValue(value)
                is Double -> NumberValue(value)
                is Int -> NumberValue(value.toDouble())
 ...
 */
sealed class FrameParams__loading {
    /**
     * String value wrapper
     */
 ...
 */
sealed class RuntimeFilter__values {
    /**
     * String value wrapper
     */
    ...
    companion object {
         ...
         * Convert a value to the appropriate union type
         */
        fun fromValue(value: Any): RuntimeFilter__values {
            return when(value) {
                is String -> StringValue(value)
                is Double -> NumberValue(value)
                is Int -> NumberValue(value.toDouble())
 ...
 */
sealed class RuntimeParameter__value {
    /**
     * String value wrapper
     */
    ...
    companion object {
         ...
         * Convert a value to the appropriate union type
         */
        fun fromValue(value: Any): RuntimeParameter__value {
            return when(value) {
                is String -> StringValue(value)
                is Double -> NumberValue(value)
                is Int -> NumberValue(value.toDouble())
 ...
 */
sealed class ColumnValue__value {
    /**
     * String value wrapper
     */
    ...
    companion object {
         ...
         * Convert a value to the appropriate union type
         */
        fun fromValue(value: Any): ColumnValue__value {
            return when(value) {
                is String -> StringValue(value)
                is Double -> NumberValue(value)
                is Int -> NumberValue(value.toDouble())
